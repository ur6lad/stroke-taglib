...
public class HierarchyVariableTest {

	private static final int VARIABLE_NUMBER = 15;

	private OmniVariable.Hierarchy variable;
	...
	public void variableToString() {
		...
		assertEquals("Hierarchy variable: to string", "hier15", testString);
	}

	@Before
	public void setUp() throws Exception {
		variable = new OmniVariable.Hierarchy(VARIABLE_NUMBER);
	}
