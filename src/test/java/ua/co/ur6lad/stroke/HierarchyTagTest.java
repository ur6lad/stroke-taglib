...
public class HierarchyTagTest {
	...
	private OmniVariableTag.Hierarchy tag;
	...
	public void happyPath() throws JspException, IOException, UnsupportedVariableException {
		...
		verify(bean).addVariable(eq(new OmniVariable.Hierarchy(VARIABLE_NUMBER)), eq(VARIABLE_VALUE));
	}

	@Before
	public void setUp() {
		tag = new OmniVariableTag.Hierarchy();
	}
