...
public class ConversionTagTest {
	...
	private OmniVariableTag.Conversion tag;
	...
	public void happyPath() throws JspException, IOException, UnsupportedVariableException {
		...
		verify(bean).addVariable(eq(new OmniVariable.Conversion(VARIABLE_NUMBER)), eq(VARIABLE_VALUE));
	}

	@Before
	public void setUp() {
		tag = new OmniVariableTag.Conversion();
	}
