...
public class ConversionVariableTest {

	private static final int VARIABLE_NUMBER = 15;

	private OmniVariable.Conversion variable;
	...
	public void variableToString() {
		...
		assertEquals("Conversion variable: to string", "eVar15", testString);
	}

	@Before
	public void setUp() throws Exception {
		variable = new OmniVariable.Conversion(VARIABLE_NUMBER);
	}
